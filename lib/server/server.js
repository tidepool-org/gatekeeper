...
module.exports = function (userApiClient, dataBroker) {
  function createServer(serverConfig) {
    ...
    retVal.get('/authorized/group/:userId', checkToken, function(req, res, next){
    ...
    retVal.get('/authorized/:groupId', checkToken, function(req, res, next){
      var tokendata = req._tokendata;
    ...
    retVal.get('/authorized/:groupId/:userId', checkToken, function(req, res, next){
      var tokendata = req._tokendata;
      if (tokendata.isserver || req.params.groupId === tokendata.userid || req.params.userId === tokendata.userid) {
        ...
        dataBroker.usersInGroup(req.params.groupId, function(err, results){
          ...
          res.send(200, results[req.params.userId]);
          return next();
        });
      }
    });
    retVal.post('/authorized/:groupId/:userId', checkToken, function(req, res, next){
      var tokendata = req._tokendata;
