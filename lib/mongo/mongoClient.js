...
module.exports = function(config){
  ...
  return {
    ...
    start: function(cb){
      ...
      const client = new mongodb.MongoClient(config.connectionString, { useNewUrlParser: true });
      const connectionURI = new URL(config.connectionString);
      databaseName = connectionURI.pathname.replace('/','') || 'gatekeeper';
