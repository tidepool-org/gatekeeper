...
module.exports = function (config) {
  ...
  return {
    ...
    start: function (cb) {
      ...
      const client = new mongodb.MongoClient(config.connectionString, { useNewUrlParser: true, readPreference: 'primary', useUnifiedTopology: true });
      ...
      client.connect(function (err) {
        ...
        mongoClient.db(databaseName).createIndex('perms',
          {
            'userId': 1,
          },
          {
